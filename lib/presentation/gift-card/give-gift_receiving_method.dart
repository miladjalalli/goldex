...
class GiveGiftReceivingMethodScreen extends StatefulWidget {
  const GiveGiftReceivingMethodScreen({super.key});

  @override
  _GiveGiftReceivingMethodScreenState createState() => _GiveGiftReceivingMethodScreenState();
}
