...
class _WithdrawalScreenState extends State<WithdrawalScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<WithdrawalCubit>()..getCurrencyBalance(),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(context.translate('yourRequestMessage'), style: TextStyle(fontSize: 16, color: Theme.of(context).colorScheme.onSurface), textAlign: TextAlign.center),
                      ),
                    ],
                  ),
                );
